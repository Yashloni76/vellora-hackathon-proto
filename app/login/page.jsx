  ...
  return (
    <div className="min-h-screen bg-primary flex items-center justify-center p-6 text-primary font-sans">
      <motion.div 
        ...
        className="w-full max-w-[440px] bg-card border border-white/5 rounded-[2.5rem] p-12 shadow-2xl shadow-green-500/5 relative overflow-hidden"
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6 relative z-10">
          <div className="space-y-2">
            <div className="relative group">
              ...
              <input 
                ...
                required
                className="w-full bg-card border border-white/5 rounded-2xl py-5 pl-14 pr-4 outline-none focus:border-green-accent/50 focus:ring-1 focus:ring-[#00ff88]/20 transition-all text-sm font-medium"
                value={email}
          ...
          <div className="space-y-2">
            <div className="relative group">
              ...
              <input 
                ...
                required
                className="w-full bg-card border border-white/5 rounded-2xl py-5 pl-14 pr-14 outline-none focus:border-green-accent/50 focus:ring-1 focus:ring-[#00ff88]/20 transition-all text-sm font-medium"
                value={password}
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-green-accent text-primary font-black py-5 rounded-2xl hover:bg-green-accent/90 transition-all active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 shadow-[0_4px_20px_rgba(0,255,136,0.15)] mt-4"
          >
          ...
          <p className="text-center text-gray-400 text-sm mt-8">
            ...
            <Link href="/signup" className="text-green-accent font-bold hover:underline">
              Sign Up
            </Link>
          </p>
        </form>

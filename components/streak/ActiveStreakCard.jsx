    ...
    <div className="card !bg-green-accent p-10 h-full flex flex-col justify-between relative overflow-hidden group hover:shadow-[0_0_60px_rgba(0,255,136,0.3)] transition-all duration-300">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end">
           <div className="space-y-1">
              <p className="text-[10px] text-black/70 font-bold tracking-widest uppercase">Next Milestone</p>
              <p className="text-sm font-black text-black uppercase tracking-tight">{streakData.nextMilestone} Days</p>
           </div>
           <p className="text-2xl font-black text-black/30 tracking-widest">{streakData.milestoneProgress}%</p>
        </div>
        
        <div className="w-full h-3 bg-black/10 rounded-full overflow-hidden border border-black/5">
           <div 
             className="h-full bg-black shadow-[0_0_15px_rgba(0,0,0,0.3)]" 
      ...
      <div className="absolute -left-10 -bottom-10 w-48 h-48 bg-black/5 rounded-full blur-[60px] pointer-events-none" />
    </div>
  );
}
